  ...
  return (
    <footer className="relative bg-white border-t border-slate-100 pt-20 overflow-hidden flex flex-col items-center">
      <div className="max-w-7xl mx-auto px-5 relative z-10 flex flex-col items-center w-full gap-16">
        ...
        <div className="flex flex-col items-center justify-center text-center gap-10 border-b border-slate-100 pb-16 w-full">
          <div className="flex flex-col items-center max-w-2xl">
            ...
            <h2 className="secondary-font text-[#092f61] font-black text-5xl sm:text-6xl md:text-7xl leading-[1.1] tracking-tighter uppercase">
          ...
          <Link 
            to="/contact"
            className="secondary-font group h-14 px-8 bg-[#e67416] text-white font-bold uppercase tracking-widest text-xs sm:text-sm flex items-center justify-center gap-3 rounded-full transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-[#e67416]/30 shrink-0"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 pb-8 w-full text-center">
          ...
          <div className="flex flex-col items-center justify-start">
            ...
            <a 
              href="mailto:hr@nmdqgrid.com" 
              className="mt-6 secondary-font text-[#092f61] text-lg font-bold hover:text-[#e67416] transition-colors"
            >
              hr@nmdqgrid.com
            </a>
          </div>
          ...
          <div className="flex flex-col items-center gap-6">
            <h4 className="secondary-font text-[#092f61] font-bold uppercase tracking-widest text-xs">
              Platform
            </h4>
              ...
              {quickLinks.map((link, idx) => (
                <li key={idx}>
                  <Link
                    to={link.path}
                    onClick={scrollToTop}
                    className="secondary-font text-slate-500 hover:text-[#e67416] hover:-translate-y-0.5 inline-block font-medium tracking-wide text-sm transition-all duration-300"
                  >
                    {link.name}
                  </Link>
                </li>
      ...
      <div className="w-full relative mt-4 flex flex-col items-center">
        ...
        {/* Floating Back To Top Button - Navy Hover */}
        <div className="relative z-20 flex justify-center w-full mb-[-28px]">
          <button
            onClick={scrollToTop}
            className="w-14 h-14 rounded-full border border-slate-200 text-slate-500 flex items-center justify-center bg-white hover:bg-[#092f61] hover:border-[#092f61] hover:text-white transition-all duration-300 shadow-lg"
        ...
        {/* The Giant Watermark - Secondary Font */}
        <div className="w-full flex justify-center overflow-hidden border-t border-slate-100 pt-10 pb-6 px-4">
          <h3 className="secondary-font text-slate-50 font-black uppercase tracking-tighter leading-none text-[16vw] sm:text-[14vw] select-none pointer-events-none text-center">
            NMDQ GRID
          </h3>
        </div>

        {/* Normal Flow Bottom Legal Bar */}
        <div className="w-full bg-white border-t border-slate-50 py-6">
          <div className="max-w-7xl mx-auto px-5 flex flex-col items-center gap-4">
            <div className="flex items-center gap-6">
              <Link to="#" className="secondary-font text-slate-400 hover:text-[#e67416] font-medium text-xs uppercase tracking-widest transition-colors">
                Privacy
              </Link>
              <Link to="#" className="secondary-font text-slate-400 hover:text-[#e67416] font-medium text-xs uppercase tracking-widest transition-colors">
                Terms
